...
![alt text](screenshots/Assignment6-SS1.png)

---

#### Screenshot 2 — Output of `pwd` and `find . -maxdepth 4 -type d | sort` showing the workspace folder structure

![alt text](screenshots/Assignment6-SS2.png)
...
![alt text](screenshots/Assignment6-SS3.png)
...
![alt text](screenshots/Assignment6-SS4.png)
...
![alt text](screenshots/Assignment6-SS5.png)

---

#### Screenshot 6 — Middle section showing check functions and conditionals

![alt text](screenshots/Assignment6-SS6.png)

---

#### Screenshot 7 — Bottom section showing the loop, summary function, and exit behavior

![alt text](screenshots/Assignment6-SS7.png)

---

#### Screenshot 8 — Output of `bash -n scripts/linux-triage.sh` (no syntax errors) and `ls -l scripts/linux-triage.sh` showing executable permission

![alt text](screenshots/Assignment6-SS8.png)
...
![alt text](screenshots/Assignment6-SS9.png)

---

#### Screenshot 10 — Output showing the captured exit code and final summary

![alt text](screenshots/Assignment6-SS10.png)
...
![alt text](screenshots/Assignment6-SS11.png)

---

#### Screenshot 12 — `/linux-triage` output for the healthy server

![alt text](screenshots/Assignment6-SS12.png)
...
![alt text](screenshots/Assignment6-SS13.png)

---

#### Screenshot 14 — `/linux-triage` output showing failed evidence, most likely cause, and a suggested recovery command

![alt text](screenshots/Assignment6-SS14a.png)
![alt text](screenshots/Assignment6-SS14b.png)
---

#### Screenshot 15 — `incident-failure-report.txt` showing the failed checks and your Full Name

![alt text](screenshots/Assignment6-SS15.png)
...
![alt text](screenshots/Assignment6-SS16.png)

---

#### Screenshot 17 — Second `/linux-triage` output showing successful recovery with no FAIL results

![alt text](screenshots/Assignment6-SS17.png)

---

#### Screenshot 18 — Output of `ls -lah reports` showing both `incident-failure-report.txt` and `recovery-report.txt`

![alt text](screenshots/Assignment6-SS18.png)

---

#### Screenshot 19 — `incident-summary.md` showing all required sections and your Full Name

![alt text](screenshots/Assignment6-SS19.png)
