...
![alt text](screenshots/Assignment2SS1.png)

---

#### Screenshot 2 — Output of `git status` showing no "not a git repository" error

![alt text](screenshots/Assignment2SS2.png)
...
![alt text](screenshots/Assignment2SS3.png)
...
![alt text](screenshots/Assignment2SS4a.png)
![alt text](screenshots/Assignment2SS4b.png)
![alt text](screenshots/Assignment2SS4c.png)
---
...
![alt text](screenshots/Assignment2SS5.png).

---

#### Screenshot 6 — Output of `git status` showing both files staged under "Changes to be committed"

![alt text](screenshots/Assignment2SS6.png)
...
![alt text](screenshots/Assignment2SS7.png)

---

#### Screenshot 8 — Output of `git log --oneline` showing the first commit

![alt text](screenshots/Assignment2SS8.png)
...
![alt text](screenshots/Assignment2SS9.png)

---

#### Screenshot 10 — Output of `git status` showing `index.html` as modified

![alt text](screenshots/Assignment2SS10.png)
![alt text](screenshots/Assignment2SS10b.png)

---

#### Screenshot 11 — Output of `git commit`

![alt text](screenshots/Assignment2SS11.png)

---

#### Screenshot 12 — Output of `git log --oneline` showing two commits

![alt text](screenshots/Assignment2SS12.png)
...
![alt text](screenshots/Assignment2SS13.png)
---

#### Screenshot 14 — Output of `curl -I http://localhost` showing `HTTP/1.1 200 OK`

![alt text](screenshots/Assignment2SS14.png)
...
https://www.linkedin.com/posts/pamela-ezeotika_devops-aws-ec2-activity-7485698091199758336-WKIN?utm_source=share&utm_medium=member_desktop&rcm=ACoAAEDjJUYBrDNdac3TpJMBKPF08Q4-AeIrB8E

---

#### Screenshot — LinkedIn post showing the deployed CodeTrack application

![alt text](screenshots/Linked-Post-1.png)
