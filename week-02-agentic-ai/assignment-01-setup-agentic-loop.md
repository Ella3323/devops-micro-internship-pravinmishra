...
week-02-agentic-ai/screenshots/Assignment1 SS1.png
---

#### Screenshot 2 — Claude Code authenticated and showing the terminal prompt (your name visible)

![alt text](<screenshots/Assignment1 SS2.png>)
...
![alt text](<screenshots/Assignment1 SS3.png>)
...
![alt text](<screenshots/Assignment1 SS4a.png>)
![alt text](<screenshots/Assignment1 SS4b.png>)

---

#### Screenshot 5 — Claude's response to the second question, showing it ran a command and reported the line count

![alt text](<screenshots/Assignment1 SS5.png>)
